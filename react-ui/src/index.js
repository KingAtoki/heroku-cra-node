...
module.exports = function(validators) {
   ...
   */
  exports.minNumberOfArguments = function(funcName, args, minSize) {
   ...
   * specified.
   */
  exports.maxNumberOfArguments = function(funcName, args, maxSize) {
  ...
  exports.customObjectError = function(val) {
